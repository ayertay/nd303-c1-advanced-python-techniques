...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        for neo in self._neos:
            self.dict_des[neo.designation] = neo
            if neo.name:
                self.dict_name[neo.name] = neo

        for approach in self._approaches:
            neo = self.dict_des[approach._designation]
            approach.neo = neo
    ...
    def get_neo_by_designation(self, designation):
        ...
        or `None`.
        """
        return self.dict_des.get(designation, None)
    ...
    def get_neo_by_name(self, name):
        ...
        """
        return self.dict_name.get(name, None)
    ...
    def query(self, filters=()):
        ...
        """
        for approach in self._approaches:
            fil = map(lambda x: x(approach), filters)
            if all(fil):
                yield approach
